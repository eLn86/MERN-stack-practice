...
var Comments = function (_Component) {
  ...
  _createClass(Comments, [{
    ...
    value: function componentWillMount() {
      ...
      fetch('http://localhost:3000/api/comment').then(function (response) {
        ...
        for (var i = 0; i < array.length; i++) {
          for (var key in array[i]) {
            if (key === 'timestamp') {
              var value = array[i][key].split('T').filter(function (str) {
                return str.includes(':');
              })[0].slice(0, 5);
              array[i][key] = value;
            }
        ...
        var updatedList = Object.assign([], _this2.state.comments);
        array.forEach(function (comment) {
          return updatedList.push(comment);
        });
        _this2.setState({
    ...
    value: function commentList() {
      return this.state.comments.map(function (comment, index) {
        return _react2.default.createElement(
          'li',
          { key: index },
          _react2.default.createElement(_Comment2.default, { info: comment })
        );
      });
    }
  }, {
    ...
    value: function handleChange(e) {
      var field = e.target.placeholder.toLowerCase();
    ...
    value: function submitComment() {
      ...
      var newObject = { body: body, username: username, timestamp: timestamp };
...
var Zones = function (_Component) {
  ...
  _createClass(Zones, [{
    ...
    value: function componentWillMount() {
      ...
      fetch('http://localhost:3000/api/zone').then(function (response) {
        return response.json();
      }).then(function (data) {
        var updatedList = Object.assign([], _this2.state.zoneList);
        data.results.forEach(function (zone) {
          return updatedList.push(zone);
        });
        _this2.setState({
    ...
    key: 'updateZoneName',
    value: function updateZoneName(zone) {
      this.setState({
        zoneName: zone
      });
    }
    ...
    value: function submitZone() {
      ...
      var zip = this.state.zipCodes;
      var updatedList = Object.assign([], this.state.zoneList);
      var lastNumOfComments = void 0;
      ...
      var newObject = { zoneName: zoneName, zipCodes: zip, numComments: lastNumOfComments };
      updatedList.push(newObject);
      this.setState({
        zoneName: '',
        zipCodes: '',
    ...
    value: function listItems() {
      return this.state.zoneList.map(function (zone, index) {
        return _react2.default.createElement(
          'li',
          { key: index },
          _react2.default.createElement(_Zone2.default, { info: zone })
        );
      });
    }
  }, {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            { style: style.link,
              href: '#' },
            this.props.info.zoneName
          )
        ),
        _react2.default.createElement(
          'span',
          { className: 'detail' },
          this.props.info.zipCodes
        ),
        _react2.default.createElement('br', null),
        _react2.default.createElement(
          'span',
          { className: 'detail' },
          this.props.info.numComments,
          ' comments'
        )
      );
    }
